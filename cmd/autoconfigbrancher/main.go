...
func main() {
	...
	if err := bumper.UpdatePullRequestWithLabels(gc, githubOrg, githubRepo, title, fmt.Sprintf("/cc @%s", o.assign), o.githubLogin, remoteBranch, "master", true, labelsToAdd); err != nil {
