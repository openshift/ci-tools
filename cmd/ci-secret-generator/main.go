...
// validateContexts checks if secret generated by ci-secret-generator are in ci-secret-bootstrap config,
// protecting against a case when we generate secrets that aren't used anywhere.
