...
## Deployment
CLI tool. Invoked via periodic Prow jobs and by the release controller for payload gating. Requires GCP service account credentials with BigQuery and GCS access.
