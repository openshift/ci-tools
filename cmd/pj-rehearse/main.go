...
func gatherOptions() (options, error) {
	...
	fs.StringVar(&o.gcsBucket, "gcs-bucket", "test-platform-results-public", "GCS Bucket to upload affected jobs list")
	...
	fs.StringVar(&o.gcsBrowserPrefix, "gcs-browser-prefix", "https://gcs.ci.openshift.org/gcs/test-platform-results-public/", "Prefix for the GCS Browser for viewing the affected jobs list")
