	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				blocked:          sets.New[string](),
				pjs: map[string]dispatcher.ProwJobData{
					"pull-ci-openshift-cluster-api-provider-gcp-master-e2e-gcp":          dispatcher.ProwJobData{Cluster: "build02"},
					"pull-ci-openshift-cluster-api-provider-gcp-master-govet":            dispatcher.ProwJobData{Cluster: "build02"},
					"pull-ci-openshift-cluster-api-provider-gcp-master-e2e-gcp-operator": dispatcher.ProwJobData{Cluster: "build02"},
					"pull-ci-openshift-cluster-api-provider-gcp-master-goimports":        dispatcher.ProwJobData{Cluster: "build02"},
				},
			},
			wantErr: false,
			expectedPjs: map[string]dispatcher.ProwJobData{
				"pull-ci-openshift-cluster-api-provider-gcp-master-e2e-gcp":          dispatcher.ProwJobData{Cluster: "build01", Capabilities: []string{"intranet"}},
				"pull-ci-openshift-cluster-api-provider-gcp-master-govet":            dispatcher.ProwJobData{Cluster: "build02"},
				"pull-ci-openshift-cluster-api-provider-gcp-master-e2e-gcp-operator": dispatcher.ProwJobData{Cluster: "build01", Capabilities: []string{"intranet"}},
				"pull-ci-openshift-cluster-api-provider-gcp-master-goimports":        dispatcher.ProwJobData{Cluster: "build02"},
			},
		},
	}
