...
func main() {
	...
	fmt.Printf("# DO NOT MODIFY. This file is generated by openshift/ci-tools sippy-config-generator on %v.\n", time.Now())
	fmt.Println("# Any manual changes will be overwritten the next time this generator runs.")
