...
echo "A sample url for a job is http://localhost:8080/view/gs/test-platform-results-public/pr-logs/pull/openshift_ci-tools/1501/pull-ci-openshift-ci-tools-master-format/1336382299314327552"
