...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiArchBuildConfigOutput) DeepCopyInto(out *MultiArchBuildConfigOutput) {
	*out = *in
	if in.To != nil {
		in, out := &in.To, &out.To
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiArchBuildConfigOutput.
func (in *MultiArchBuildConfigOutput) DeepCopy() *MultiArchBuildConfigOutput {
	if in == nil {
		return nil
	}
	out := new(MultiArchBuildConfigOutput)
	in.DeepCopyInto(out)
	return out
}
