...
func (config ReleaseBuildConfiguration) IsBaseImage(name string) bool {
	...
	for i := range config.ExternalImages {
		if i == name {
			return true
		}
	}
