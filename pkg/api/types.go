...
// UnmarshalJSON supports both the new struct format and the legacy format
// where images was a plain array of ProjectDirectoryImageBuildStepConfiguration.
func (ic *ImageConfiguration) UnmarshalJSON(data []byte) error {
	// Try legacy format: a plain array
	...
	// New struct format
	type imageConfigurationAlias ImageConfiguration
	var alias imageConfigurationAlias
	if err := json.Unmarshal(data, &alias); err != nil {
		return err
	}
	*ic = ImageConfiguration(alias)
	return nil
}
