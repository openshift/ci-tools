...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JobQueueConfig) DeepCopyInto(out *JobQueueConfig) {
	*out = *in
	if in.JobQueues != nil {
		in, out := &in.JobQueues, &out.JobQueues
		*out = make(map[string]JobQueue, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JobQueueConfig.
func (in *JobQueueConfig) DeepCopy() *JobQueueConfig {
	if in == nil {
		return nil
	}
	out := new(JobQueueConfig)
	in.DeepCopyInto(out)
	return out
}
