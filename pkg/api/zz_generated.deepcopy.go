...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Prowgen) DeepCopyInto(out *Prowgen) {
	*out = *in
	in.Rehearsals.DeepCopyInto(&out.Rehearsals)
	if in.SlackReporterConfigs != nil {
		in, out := &in.SlackReporterConfigs, &out.SlackReporterConfigs
		*out = make([]SlackReporterConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SkipOperatorPresubmits != nil {
		in, out := &in.SkipOperatorPresubmits, &out.SkipOperatorPresubmits
		*out = make([]SkipOperatorPresubmit, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Prowgen.
func (in *Prowgen) DeepCopy() *Prowgen {
	if in == nil {
		return nil
	}
	out := new(Prowgen)
...
func (in *ProwgenExtras) DeepCopyInto(out *ProwgenExtras) {
	*out = *in
	in.Prowgen.DeepCopyInto(&out.Prowgen)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Rehearsals) DeepCopyInto(out *Rehearsals) {
	*out = *in
	if in.DisabledRehearsals != nil {
		in, out := &in.DisabledRehearsals, &out.DisabledRehearsals
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Rehearsals.
func (in *Rehearsals) DeepCopy() *Rehearsals {
	if in == nil {
		return nil
	}
	out := new(Rehearsals)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SkipOperatorPresubmit) DeepCopyInto(out *SkipOperatorPresubmit) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SkipOperatorPresubmit.
func (in *SkipOperatorPresubmit) DeepCopy() *SkipOperatorPresubmit {
	if in == nil {
		return nil
	}
	out := new(SkipOperatorPresubmit)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SlackReporterConfig) DeepCopyInto(out *SlackReporterConfig) {
	*out = *in
	...
	if in.JobNamePatterns != nil {
		in, out := &in.JobNamePatterns, &out.JobNamePatterns
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ExcludedVariants != nil {
		in, out := &in.ExcludedVariants, &out.ExcludedVariants
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ExcludedJobPatterns != nil {
		in, out := &in.ExcludedJobPatterns, &out.ExcludedJobPatterns
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
