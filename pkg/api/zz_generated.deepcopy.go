...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DockerfileEntry) DeepCopyInto(out *DockerfileEntry) {
	*out = *in
	if in.GoBinaryTargets != nil {
		in, out := &in.GoBinaryTargets, &out.GoBinaryTargets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DockerfileEntry.
func (in *DockerfileEntry) DeepCopy() *DockerfileEntry {
	if in == nil {
		return nil
	}
	out := new(DockerfileEntry)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestStepConfiguration) DeepCopyInto(out *TestStepConfiguration) {
	*out = *in
	...
	if in.PipelineRunIfDockerfileChanged != nil {
		in, out := &in.PipelineRunIfDockerfileChanged, &out.PipelineRunIfDockerfileChanged
		*out = make([]DockerfileEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
