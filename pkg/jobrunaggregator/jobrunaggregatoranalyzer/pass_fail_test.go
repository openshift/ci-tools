...
func TestCheckPercentileDisruption(t *testing.T) {
	...
	tests := []struct {
		...
		// https://prow.ci.openshift.org/view/gs/test-platform-results-public/logs/aggregated-azure-ovn-upgrade-4.14-micro-release-openshift-release-analysis-aggregator/1671560866929053696
