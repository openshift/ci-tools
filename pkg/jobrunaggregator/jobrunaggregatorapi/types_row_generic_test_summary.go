...
// GenericTestSummaryByPeriodRow represents aggregated test results for a specific suite and release over a time period,
// without breaking down by infrastructure dimensions (platform, topology, architecture).
// This provides a higher-level view of test reliability across all infrastructure variants.
type GenericTestSummaryByPeriodRow struct {
