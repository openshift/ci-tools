...
var (
	jobsToAnalyze = []jobrunaggregatorapi.JobRow{
		...
		// 4.10 nightly
		newJob("periodic-ci-openshift-release-master-ci-4.10-e2e-azure-upgrade-single-node").ToJob(),
		...
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-ipi").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-ipi-ovn-ipv6").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-ipi-serial-ipv4").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-console-aws").ToJob(),
		...
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-assisted").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-assisted-ipv6").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-ipi-ovn-dualstack").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-ipi-virtualmedia").ToJob(),
		newJob("release-openshift-ocp-installer-e2e-metal-serial-4.10").ToJob(),
		newJob("release-openshift-ocp-osd-aws-nightly-4.10").ToJob(),
		newJob("release-openshift-ocp-osd-gcp-nightly-4.10").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-ovirt").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-aws-proxy").ToJob(),
		newJob("periodic-ci-openshift-release-master-nightly-4.10-e2e-metal-single-node-live-iso").ToJob(),
