...
type ImageStreamOperationType string

const (
	ImageStreamOperationTypeCached  ImageStreamOperationType = "cached"
	ImageStreamOperationTypeCreated ImageStreamOperationType = "created"
	ImageStreamOperationTypeError   ImageStreamOperationType = "error"
)

type TagImportOperationType string
