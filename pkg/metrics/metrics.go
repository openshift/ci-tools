...
func NewMetricsAgent(ctx context.Context, client ctrlruntimeclient.Client) *MetricsAgent {
	...
	return &MetricsAgent{
		...
		nodesPlugin:    newNodesMetricsPlugin(client, nodesCh),
	}
}
