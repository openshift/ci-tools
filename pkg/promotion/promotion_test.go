	...
	testCases := []struct {
		...
		},
		{
			...
			config: &cioperatorapi.ReleaseBuildConfiguration{
				...
				Images: cioperatorapi.ImageConfiguration{Items: []cioperatorapi.ProjectDirectoryImageBuildStepConfiguration{{To: cioperatorapi.PipelineImageStreamTagReferenceSource}}},
			},
		},
		{
