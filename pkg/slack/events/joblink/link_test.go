...
func TestExtractInfo(t *testing.T) {
	var testCases = []struct {
		...
		{
			link:     "https://prow.ci.openshift.org/job-history/gs/test-platform-results/logs/release-openshift-origin-installer-e2e-gcp-upgrade-4.7",
		...
		{
			link:     "https://gcsweb-ci.apps.ci.l2s4.p1.openshiftapps.com/gcs/test-platform-results/pr-logs/pull/25585/pull-ci-openshift-origin-master-e2e-aws-disruptive/1319310480841379840/artifacts/123/123123/123/12/312/3/1",
			expected: &jobInfo{Name: "pull-ci-openshift-origin-master-e2e-aws-disruptive", Id: "1319310480841379840"},
		},
		{
			link:     "https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/openshift_release/12371/rehearse-12371-periodic-ci-kubevirt-kubevirt-master-e2e-nested-virt/1318930182802771968",
			expected: &jobInfo{Name: "rehearse-12371-periodic-ci-kubevirt-kubevirt-master-e2e-nested-virt", Id: "1318930182802771968"},
		},
		{
			link:     "https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/openshift_tektoncd-pipeline-operator/495/pull-ci-openshift-tektoncd-pipeline-operator-release-next-4.4-csv/1319068241137504256#1:build-log.txt%3A58",
			expected: &jobInfo{Name: "pull-ci-openshift-tektoncd-pipeline-operator-release-next-4.4-csv", Id: "1319068241137504256", Line: 58},
		},
		{
			link:     "https://prow.ci.openshift.org/view/gs/test-platform-results/logs/periodic-openshift-library-import/1319699861964066816",
			expected: &jobInfo{Name: "periodic-openshift-library-import", Id: "1319699861964066816"},
		},
		{
			link:     "https://gcsweb-ci.apps.ci.l2s4.p1.openshiftapps.com/gcs/test-platform-results/logs/periodic-openshift-library-import/1319699861964066816/clone-records.json",
			expected: &jobInfo{Name: "periodic-openshift-library-import", Id: "1319699861964066816"},
		},
		{
			link:     "https://prow.ci.openshift.org/view/gs/test-platform-results/pr-logs/pull/batch/pull-ci-openshift-origin-release-4.5-unit/1319699245074223104",
			expected: &jobInfo{Name: "pull-ci-openshift-origin-release-4.5-unit", Id: "1319699245074223104"},
		},
		{
			link:     "https://prow.ci.openshift.org/view/gs/test-platform-results/logs/branch-ci-openshift-k8s-prometheus-adapter-release-4.8-images/1319705916215398400",
		...
		{
			link:     "https://storage.googleapis.com/test-platform-results/pr-logs/pull/25585/pull-ci-openshift-origin-master-e2e-aws-disruptive/1319310480841379840/build-log.txt",
			expected: &jobInfo{Name: "pull-ci-openshift-origin-master-e2e-aws-disruptive", Id: "1319310480841379840"},
		},
		{
			link:     "https://storage.googleapis.com/test-platform-results/pr-logs/pull/25585/pull-ci-openshift-origin-master-e2e-aws-disruptive/1319310480841379840/artifacts/123/123123/123/12/312/3/1",
			expected: &jobInfo{Name: "pull-ci-openshift-origin-master-e2e-aws-disruptive", Id: "1319310480841379840"},
		},
	}
