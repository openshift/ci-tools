...
func TestAssembleReleaseVersionPrefix(t *testing.T) {
	tests := []struct {
		...
		{name: "legacy 5.0-priv stream", config: &api.ReleaseTagConfiguration{Name: "5.0-priv"}, want: "5.0.0-0"},
		{name: "legacy 4.19-priv stream", config: &api.ReleaseTagConfiguration{Name: "4.19-priv"}, want: "4.19.0-0"},
