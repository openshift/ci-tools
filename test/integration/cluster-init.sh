...
generate_cluster_install "newCluster" "$actual_create" "cluster-install-newCluster.yaml"
generate_kubeconfig "newCluster"
os::cmd::expect_success "cluster-init --cluster-install=${tempdir}/cluster-install-newCluster.yaml onboard config generate --hosted --create-pr=false"
...
generate_cluster_install "existingCluster" "$actual_update" "cluster-install-existingCluster.yaml"
...
generate_cluster_install "newCluster" "$actual_create" "cluster-install-newCluster-ocp.yaml"
generate_kubeconfig "newCluster"
os::cmd::expect_success "cluster-init onboard --cluster-install=${tempdir}/cluster-install-newCluster-ocp.yaml config generate --create-pr=false --osd=false"
os::integration::compare "${actual_create}" "${expected_create}"
# test the update scenario
actual_update="${tempdir}/update-ocp/input"
expected_update="${suite_dir}/update-ocp/expected"
generate_cluster_install "existingCluster" "$actual_update" "cluster-install-existingCluster-ocp.yaml"
generate_kubeconfig "existingCluster"
os::cmd::expect_success "cluster-init onboard --cluster-install=${tempdir}/cluster-install-existingCluster-ocp.yaml config generate --update=true --create-pr=false --osd=false"
os::integration::compare "${actual_update}" "${expected_update}"
