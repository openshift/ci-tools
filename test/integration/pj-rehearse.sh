...
os::cmd::expect_success "ci-operator-checkconfig --config-dir ${suite_dir}/master/ci-operator/config --registry ${suite_dir}/master/ci-operator/step-registry --cluster-profiles-config ${suite_dir}/master/core-services/cluster-profiles/_config.yaml"
os::cmd::expect_success "ci-operator-checkconfig --config-dir ${suite_dir}/candidate/ci-operator/config --registry ${suite_dir}/candidate/ci-operator/step-registry --cluster-profiles-config ${suite_dir}/candidate/core-services/cluster-profiles/_config.yaml"
